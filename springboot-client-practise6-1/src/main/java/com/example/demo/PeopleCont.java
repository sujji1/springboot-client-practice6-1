...
public class PeopleCont {
	...
	@PostMapping("/people")
	public ResponseEntity<People>savedata(@RequestBody People p){
	...
	public ResponseEntity<People>get(@PathVariable int pid,@RequestBody People p){
	...
	public ResponseEntity<Gold>delete(@PathVariable int id,@RequestBody People p){
